...
legend_html = """
     ...
     bottom: 50px; left: 50px; width: 220px; height: 400px;
     border:2px solid grey; z-index:9999; font-size:14px;
     background-color:white; opacity: .8; padding: 10px;">
     <h4 style="text-align: center;">خدمات شهری</h4>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:blue;"></span>
       <span style="text-align: right; margin-right: 5px;">بانک</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:green;"></span>
       <span style="text-align: right; margin-right: 5px;">باشگاه</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:orange;"></span>
       <span style="text-align: right; margin-right: 5px;">مراکز درمانی</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:red;"></span>
       <span style="text-align: right; margin-right: 5px;">مدرسه</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:purple;"></span>
       <span style="text-align: right; margin-right: 5px;">پارک</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:black;"></span>
       <span style="text-align: right; margin-right: 5px;">تاکسی</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:darkblue;"></span>
       <span style="text-align: right; margin-right: 5px;">پلیس</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:lightblue;"></span>
       <span style="text-align: right; margin-right: 5px;">مسجد</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:pink;"></span>
       <span style="text-align: right; margin-right: 5px;">بازار</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:brown;"></span>
       <span style="text-align: right; margin-right: 5px;">پمپ بنزین</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:darkred;"></span>
       <span style="text-align: right; margin-right: 5px;">آتش نشانی</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:darkgreen;"></span>
       <span style="text-align: right; margin-right: 5px;">دانشگاه</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:gray;"></span>
       <span style="text-align: right; margin-right: 5px;">ادارات</span>
     </div>
      <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:cadetblue;"></span>
       <span style="text-align: right; margin-right: 5px;">اداره آب و فاضلاب</span>
     </div>
     <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:lightgreen;"></span>
       <span style="text-align: right; margin-right: 5px;">اداره منابع طبیعی</span>
     </div>
          <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:indianred;"></span>
       <span style="text-align: right; margin-right: 5px;">هلال احمر</span>
     </div>
          <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:beige;"></span>
       <span style="text-align: right; margin-right: 5px;">کتابخانه</span>
     </div>
          <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:darkpurple;"></span>
       <span style="text-align: right; margin-right: 5px;">میدان بار</span>
     </div>
          <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:lightgray;"></span>
       ...
       <span style="text-align: right; margin-right: 5px;">پارکینگ</span>
               ...
               <div style="display: flex; align-items: center; margin-bottom: 5px;">
       <span style="display:inline-block; width: 10px; height: 10px; border-radius: 50%; margin-left: 5px; background-color:darkorange;"></span>
        ...
        if not gdf.empty:
            ...
            for _, row in gdf.iterrows():
                ...
                folium.CircleMarker(
                    ...
                    fill=True,
                    fill_opacity=0.6,
                    tooltip=f"{point_name}"  # نمایش نام نقطه در تولتیپ
